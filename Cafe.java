...
public class Cafe{
    public static void main(String[] args){
        ...
        System.out.println("Welcome to the " + cafeName + " Cafe!");
        orderFood coffee = new orderFood("Coffee", 2.50);
        orderFood muffin = new orderFood("Muffin", 3.00);
        orderFood sandwich = new orderFood("Sandwich", 5.00);
        orderFood pancake = new orderFood("Pancake", 4.00);
        orderFood bagel = new orderFood("Bagel", 2.00);
        orderFood breakfastBurrito = new orderFood("Breakfast Burrito", 6.00);
        orderFood waffle = new orderFood("Waffle", 4.50);
        orderFood friedEgg = new orderFood("Fried Egg", 1.50);
        orderFood sausage = new orderFood("Sausage", 2.00);
        orderFood hashbrowns = new orderFood("Hashbrowns", 2.50);
        orderFood toast = new orderFood("Toast", 1.50);
        double money = 100;
